...
export interface SGLLendingBorrowingInterface extends utils.Interface {
  functions: {
...
export interface SGLLendingBorrowing extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SGLLendingBorrowingInterface;
