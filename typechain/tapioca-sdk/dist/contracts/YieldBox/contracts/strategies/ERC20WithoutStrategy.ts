...
export interface ERC20WithoutStrategyInterface extends utils.Interface {
  functions: {
...
export interface ERC20WithoutStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20WithoutStrategyInterface;
