...
export interface BaseERC20StrategyInterface extends utils.Interface {
  functions: {
...
export interface BaseERC20Strategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseERC20StrategyInterface;
