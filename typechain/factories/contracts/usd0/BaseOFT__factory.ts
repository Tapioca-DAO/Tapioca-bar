...
export class BaseOFT__factory {
  static readonly abi = _abi;
  static createInterface(): BaseOFTInterface {
    return new utils.Interface(_abi) as BaseOFTInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BaseOFT {
    return new Contract(address, _abi, signerOrProvider) as BaseOFT;
  }
}
