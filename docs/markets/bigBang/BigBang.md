...
```solidity
function borrowModule() external view returns (contract BBBorrow)
```
...
```solidity
function collateralModule() external view returns (contract BBCollateral)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract BBCollateral | undefined |
...
Allows batched call to BingBang.
...
```solidity
function leverageModule() external view returns (contract BBLeverage)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract BBLeverage | undefined |
...
```solidity
function liquidationModule() external view returns (contract BBLiquidation)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract BBLiquidation | undefined |
...
```solidity
function setBigBangConfig(uint256 _minDebtRate, uint256 _maxDebtRate, uint256 _debtRateAgainstEthMarket, uint256 _liquidationMultiplier) external nonpayable
```

sets BigBang specific configuration
...
| Name | Type | Description |
|---|---|---|
| _minDebtRate | uint256 | undefined |
| _maxDebtRate | uint256 | undefined |
